    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-muted" id="pricing">
      <div className="container grid gap-12 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="flex flex-col">
            <CardHeader className="bg-secondary text-secondary-foreground p-6 dark:bg-primary">
            ...
            <CardContent className="p-6 flex-1">
              <ul className="grid gap-3 text-muted-foreground">
                <li className="flex items-center gap-2">
                  <CheckIcon className="h-5 w-5 fill-secondary" />
                  Advanced targeting
                </li>
                <li className="flex items-center gap-2">
                  <CheckIcon className="h-5 w-5 fill-secondary" />
          ...
          <Card className="flex flex-col">
            <CardHeader className="bg-accent text-accent-foreground p-6 dark:bg-primary">
            ...
            <CardContent className="p-6 flex-1">
              <ul className="grid gap-3 text-muted-foreground">
                <li className="flex items-center gap-2">
                  <CheckIcon className="h-5 w-5 fill-accent" />
                  All features
                </li>
                <li className="flex items-center gap-2">
                  <CheckIcon className="h-5 w-5 fill-accent" />
